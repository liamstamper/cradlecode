      ...
      {!location.pathname.includes("/practice") &&
        !location.pathname.includes("/gettingstarted") && (
          <header class="flex flex-wrap  md:justify-start md:flex-nowrap z-50 w-full bg-white  dark:bg-black ">
            <nav class="relative max-w-[75rem] w-full mx-auto md:flex md:items-center md:justify-between md:gap-3 py-2 px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="py-1 md:px-1 space-y-0.5">
                              ...
                              >
                                ...
                                <div class="grow">
                                  ...
                                  <p class="text-sm text-gray-500 dark:text-neutral-500">
                                    Meet the people building products to help
                                    your business grow
                                  </p>
                                </div>
                              </a>
                              ...
                              >
                                ...
                                <div class="grow">
                                  ...
                                  <p class="text-sm text-gray-500 dark:text-neutral-500">
                                    The latest news, feature releases, and how
                                    to grow with data
                                  </p>
                                </div>
                              </a>
